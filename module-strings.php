...
__( 'By default, Solid Security will zip backup files to reduce file size. You may need to turn this off if you are having problems with backups.', 'it-l10n-ithemes-security-pro' );
...
__( 'Solid Security automatically adds an IP to the ban list once it meets the Ban Threshold requirements. The Ban Threshold setting can be adjusted in the [Global Settings](itsec://settings/configure/global). You can manually add IPs to the ban list from the Security Dashboard using the Banned IPs card.', 'it-l10n-ithemes-security-pro' );
...
__( 'Automatically lockout “admin” user', 'it-l10n-ithemes-security-pro' );
__( 'Immediately lockout an IP address that attempts to login using the “admin” username.', 'it-l10n-ithemes-security-pro' );
__( 'Max Login Attempts Per IP', 'it-l10n-ithemes-security-pro' );
__( 'The number of login attempts that can be made before an IP address is locked out of the system. Set to 0 to record bad login attempts without creating a lockout.', 'it-l10n-ithemes-security-pro' );
...
__( 'Sets a secure key that Solid Security uses to encrypt sensitive values like Two-Factor codes.', 'it-l10n-ithemes-security-pro' );
__( 'Solid Security will add a constant to your website’s <code>wp-config.php</code> file named <code>ITSEC_ENCRYPTION_KEY</code>.', 'it-l10n-ithemes-security-pro' );
...
__( 'Create MU Plugin Loader', 'it-l10n-ithemes-security-pro' );
__( 'For better security and optimized performance Solid Security can be loaded as an MU-Plugin. Run this tool to automatically create the MU Plugin.', 'it-l10n-ithemes-security-pro' );
__( 'Remove MU Plugin Loader', 'it-l10n-ithemes-security-pro' );
__( 'For better security and optimized performance Solid Security is being loaded as an MU-Plugin. Run this tool to automatically remove the MU Plugin.', 'it-l10n-ithemes-security-pro' );
# END MODULE: core
...
__( 'Allow users to create new Solid Security Dashboards.', 'it-l10n-ithemes-security-pro' );
...
__( 'Feature Flags in Solid Security allow you to try experimental features before they are released.', 'it-l10n-ithemes-security-pro' );
...
__( 'Firewall Rules Engine', 'it-l10n-ithemes-security-pro' );
__( 'Protect your site with firewall rules.', 'it-l10n-ithemes-security-pro' );
__( 'Max Firewall Violations Per IP address', 'it-l10n-ithemes-security-pro' );
__( 'The number of times a firewall rule can be triggered before an attacker will be locked out for an extended period of time.', 'it-l10n-ithemes-security-pro' );
__( 'Minutes to Remember (check period)', 'it-l10n-ithemes-security-pro' );
__( 'The number of minutes a firewall violation should be remembered.', 'it-l10n-ithemes-security-pro' );
# END MODULE: firewall

# BEGIN MODULE: global
__( 'Global Settings', 'it-l10n-ithemes-security-pro' );
__( 'Configure basic settings that control how Solid Security functions.', 'it-l10n-ithemes-security-pro' );
__( 'Changes made here are applied globally throughout Solid Security’s settings. For example, the lockout settings and messages are used by all of Solid Security’s lockout features.', 'it-l10n-ithemes-security-pro' );
__( 'Write to Files', 'it-l10n-ithemes-security-pro' );
__( 'Allow Solid Security to write to wp-config.php and .htaccess automatically. If this box is not checked, you will need to edit those files manually.', 'it-l10n-ithemes-security-pro' );
__( 'NGINX Conf File', 'it-l10n-ithemes-security-pro' );
__( 'This path must be writable by WordPress. For security reasons, we recommend you do not include it in your website’s root folder.', 'it-l10n-ithemes-security-pro' );
__( 'Minutes to Lockout', 'it-l10n-ithemes-security-pro' );
__( 'The length of time an IP address or user will be locked out from this site after hitting the limit for failed logins. The default setting of 15 minutes is recommended. Increasing it could prevent attackers from being banned.', 'it-l10n-ithemes-security-pro' );
__( 'Days to Remember Lockouts', 'it-l10n-ithemes-security-pro' );
__( 'How many days should Solid Security remember a lockout? This does not affect the logs generated when creating a lockout.', 'it-l10n-ithemes-security-pro' );
__( 'Ban Repeat Offender', 'it-l10n-ithemes-security-pro' );
__( 'Permanently add a locked-out IP address to the “Ban Users” list after reaching the configured “Ban Threshold.”', 'it-l10n-ithemes-security-pro' );
__( 'Ban Threshold', 'it-l10n-ithemes-security-pro' );
__( 'The number of lockouts Solid Security must remember before permanently banning the attacker.', 'it-l10n-ithemes-security-pro' );
__( 'IP Lockout Message', 'it-l10n-ithemes-security-pro' );
__( 'Display this message when an IP address has been locked out.', 'it-l10n-ithemes-security-pro' );
__( 'User Lockout Message', 'it-l10n-ithemes-security-pro' );
__( 'The message to display to a user when they have been locked out.', 'it-l10n-ithemes-security-pro' );
__( 'Community Lockout Message', 'it-l10n-ithemes-security-pro' );
__( 'The message to display to a user when their IP has been flagged as suspicious by the SolidWP network.', 'it-l10n-ithemes-security-pro' );
__( 'Automatically Temporarily Authorize IPs', 'it-l10n-ithemes-security-pro' );
__( 'Whenever an administrator user accesses the website, Solid Security will prevent their last used IP from being locked out for 24 hours.', 'it-l10n-ithemes-security-pro' );
__( 'Authorized IPs', 'it-l10n-ithemes-security-pro' );
__( 'Enter a list of IP addresses that should not be locked out by Solid Security.', 'it-l10n-ithemes-security-pro' );
__( 'whitelist', 'it-l10n-ithemes-security-pro' );
__( 'How should event logs be kept', 'it-l10n-ithemes-security-pro' );
__( 'Solid Security can log events in two different ways. Each has advantages and disadvantages. Database Only logs puts all events in the database with your posts and other WordPress data. This makes it easy to retrieve and process that information, but it can slow down your site if the log table gets very large. File Only logging is very fast, but the plugin does not process the logs itself. That would take far more server resources. For most users or smaller sites, Database Only logging should be fine. If you have a very large site or log processing software, then File Only might be a better option.', 'it-l10n-ithemes-security-pro' );
...
__( 'The number of days file logs should be kept. File logs will be rotated once the file hits 10MB. Set to 0 to only use log rotation.', 'it-l10n-ithemes-security-pro' );
__( 'Path to Log Files', 'it-l10n-ithemes-security-pro' );
__( 'This folder must be writable. For security reasons, we recommend you do not save logs in your website\'s root folder.', 'it-l10n-ithemes-security-pro' );
__( 'Proxy Detection', 'it-l10n-ithemes-security-pro' );
__( 'Configure the method Solid Security uses to identify the IP address of your site’s visitors and users. Choose “Security Check Scan” to allow Solid Security to automatically configure the correct method. When this setting is configured incorrectly, key firewall features will not work properly.<br>[Read more about IP Detection](https://go.solidwp.com/about-ip-detection).', 'it-l10n-ithemes-security-pro' );
__( 'Proxy Header', 'it-l10n-ithemes-security-pro' );
__( 'Select the HTTP header record used by your proxy server or load balancer to forward the IP address of each site visitor. Contact your hosting provider or proxy service provider (Cloudflare, etc.) to determine the correct setting. When configured correctly, the “Detected IP” shown above should match your current IP address.', 'it-l10n-ithemes-security-pro' );
__( 'Hide Security Menu in Admin Bar', 'it-l10n-ithemes-security-pro' );
__( 'Remove the Security Messages Menu from the Admin Bar. Notifications will only appear on the Solid Security dashboard and settings pages.', 'it-l10n-ithemes-security-pro' );
__( 'Allow Data Sharing', 'it-l10n-ithemes-security-pro' );
__( 'If you opt-in, some data about your usage of this plugin and future StellarWP Products will be shared with our teams (so they can work their butts off to improve). We will also share some helpful info on WordPress, and our products from time to time. If you don\'t opt in, that\'s okay! Our products still work just fine.<br>[Read more about usage sharing](https://go.solidwp.com/opt-in-usage-sharing).', 'it-l10n-ithemes-security-pro' );
__( 'Show Error Codes', 'it-l10n-ithemes-security-pro' );
__( 'Each error message in Solid Security has an associated error code that can help diagnose an issue. Changing this setting to “Yes” causes these codes to be displayed. This setting should be left set to “No” unless Solid Security\'s customer success team requests that you change it.', 'it-l10n-ithemes-security-pro' );
...
__( 'Other', 'it-l10n-ithemes-security-pro' );
__( 'Manage Solid Security', 'it-l10n-ithemes-security-pro' );
__( 'Allow users to manage Solid Security.', 'it-l10n-ithemes-security-pro' );
...
__( 'The correct list of server IPs is important to prevent erroneous lockouts and trusted device errors.', 'it-l10n-ithemes-security-pro' );
# END MODULE: global

# BEGIN MODULE: hibp
__( 'Refuse Compromised Passwords', 'it-l10n-ithemes-security-pro' );
__( 'Reject passwords that have appeared in password breaches tracked by haveibeenpwned.com. This is a secure API call that does not transmit complete, unhashed passwords.', 'it-l10n-ithemes-security-pro' );
# END MODULE: hibp
...
__( 'Manage and configure email notifications sent by Solid Security related to various features.', 'it-l10n-ithemes-security-pro' );
...
__( 'Solid Security will send notifications from this email address. Leave blank to use the WordPress default.', 'it-l10n-ithemes-security-pro' );
...
__( 'Detects the correct way to identify user IP addresses based on your server configuration by making an API request to SolidWP.com servers. No user information is sent to SolidWP. [Read our Privacy Policy](https://go.solidwp.com/solid-privacy-policy).', 'it-l10n-ithemes-security-pro' );
...
__( 'Require strong passwords approved by the WordPress password strength meter.', 'it-l10n-ithemes-security-pro' );
__( 'Strong Passwords', 'it-l10n-ithemes-security-pro' );
__( 'Require strong passwords approved by the WordPress password strength meter.', 'it-l10n-ithemes-security-pro' );
...
__( 'Two-Factor Authentication greatly increases the security of your WordPress user account by requiring an additional code along with your username and password to log in.', 'it-l10n-ithemes-security-pro' );
__( 'Two-Factor authentication is a tried and true security method that will stop most automated bot attacks on the WordPress login screen. Once Two-Factor Authentication is enabled here, users can visit their profile settings to enable it on their account.', 'it-l10n-ithemes-security-pro' );
...
__( 'Solid Security supports multiple two-factor authentication methods: mobile apps, email messages, and backup codes. Selecting “All Methods” is highly recommended so that users can choose the method that works the best for them.', 'it-l10n-ithemes-security-pro' );
...
__( 'This simplifies the signup flow for users who require two-factor to be enabled for their account.', 'it-l10n-ithemes-security-pro' );
__( 'Onboarding Welcome Text', 'it-l10n-ithemes-security-pro' );
__( 'Customize the text shown to users at the beginning of the Two-Factor onboarding flow.', 'it-l10n-ithemes-security-pro' );
...
__( 'Use Application Passwords to allow authentication without providing your actual password when using non-traditional login methods such as XML-RPC or the REST API. Application passwords are easily revoked and can never be used in the traditional login process.', 'it-l10n-ithemes-security-pro' );
...
__( 'Trusted Devices', 'it-l10n-ithemes-security-pro' );
...
__( 'Require users to set new passwords after an expiration period has passed.', 'it-l10n-ithemes-security-pro' );
__( 'Maximum Password Age', 'it-l10n-ithemes-security-pro' );
__( 'The maximum number of days a password may be kept before it expires.', 'it-l10n-ithemes-security-pro' );
...
__( 'Allow users to log in without entering a password by using passkeys or emailing them a secure, instant login link instead.', 'it-l10n-ithemes-security-pro' );
__( 'Available Authentication Methods', 'it-l10n-ithemes-security-pro' );
__( 'Solid Security supports multiple passwordless login methods.', 'it-l10n-ithemes-security-pro' );
...
__( 'By default, all users selected above will be able to use passwordless login. Change to “Disabled” if you prefer to have users opt-in themselves.', 'it-l10n-ithemes-security-pro' );
...
__( 'Passkey User Verification', 'it-l10n-ithemes-security-pro' );
__( 'User Verification is an additional authentication step for using passkeys. For example, a PIN or biometric authentication might be required. By default, Solid Security asks your browser to determine the verification steps to apply. However, you can make this additional user verification mandatory by selecting “Required” here. User verification is not yet supported on all browsers, including Mozilla Firefox on MacOS.', 'it-l10n-ithemes-security-pro' );
__( 'Preferred', 'it-l10n-ithemes-security-pro' );
__( 'Required', 'it-l10n-ithemes-security-pro' );
__( 'Passkeys', 'it-l10n-ithemes-security-pro' );
...
__( 'Require vulnerable user accounts to use two-factor authentication even if they haven\'t opted-in or previously had this as a requirement. Enabling this feature is highly recommended for users with weak passwords or any that attackers have targeted.', 'it-l10n-ithemes-security-pro' );
__( 'Vulnerable Site Protection', 'it-l10n-ithemes-security-pro' );
__( 'Require all users to use two-factor authentication to log in when the site is vulnerable due to outdated or exploitable software. Enabling this feature is highly recommended.', 'it-l10n-ithemes-security-pro' );
__( 'Protection', 'it-l10n-ithemes-security-pro' );
__( 'Require Two Factor', 'it-l10n-ithemes-security-pro' );
__( 'Require users to use two-factor authentication. We highly recommended requiring two-factor authentication for all users who can make changes to the site.', 'it-l10n-ithemes-security-pro' );
__( 'Force Two Factor', 'it-l10n-ithemes-security-pro' );
__( 'Allow Remembering Device', 'it-l10n-ithemes-security-pro' );
__( 'When logging in, users will be presented with a “Remember this Device” option. If enabled, users won’t be prompted to provide a two-factor authentication code for the next 30 days while using a remembered device.', 'it-l10n-ithemes-security-pro' );
...
__( 'To assist with GDPR compliance, Solid Security can prompt the user to accept the CAPTCHA provider’s Privacy Policy and Terms of Service before loading the challenge.', 'it-l10n-ithemes-security-pro' );
...
__( 'The numbers of failed CAPTCHA entries that will trigger a lockout. Set to zero (0) to record errors without locking out users. This can be useful for troubleshooting. The default is 7.', 'it-l10n-ithemes-security-pro' );
